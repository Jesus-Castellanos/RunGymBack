...
namespace RunGym.Repositorios
{
    public class DatabaseService : DbContext
    {
        ...
        private void EntityConfuguration(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Dieta>().Property(u => u.Micronutrientes).HasColumnName("Micronutrientes");
            ...
            modelBuilder.Entity<Rol>().Property(u => u.NombreRol).HasColumnName("NombreRol");
        }
